...
Revision ID: 48065f52d25b
Revises: 
Create Date: 2017-05-18 14:36:16.921989
...
def upgrade():
    ...
    sa.Column('language', sa.Enum('فارسی', 'انگلیسی', 'عربی', 'همه\u200cی زبان\u200cها'), nullable=True),
    sa.Column('source', sa.Enum('پاسخ\u200cهای کاربران سایت', 'تگ\u200cهای اینستاگرام', 'تگ\u200cهای اینستاگرام و پاسخ\u200cهای کاربران سایت'), nullable=True),
    ...
    sa.Column('degree', sa.Enum('کارشناسی ارشد و دکتری', 'کارشناسی', 'فوق دیپلم', 'دیپلم', 'زیر دیپلم'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['phrase1_id'], ['phrase.id'], ),
    sa.ForeignKeyConstraint(['phrase2_id'], ['phrase.id'], ),
    sa.PrimaryKeyConstraint('number', 'phrase1_id', 'phrase2_id', 'pack_id')
    )
