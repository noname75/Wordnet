...
!function (t, e) {
    ...
    return o = window.document, e = function () {
        ...
        return e.prototype.addSteps = function (t) {
            ...
            return this._debug("Scroll into view. ScrollTop: " + u + ". Element offset: " + a + ". Window height: " + p + "."), i = 0, t("body, html").stop(!0, !0).animate({scrollTop: Math.ceil(u)}, function (t) {
                return function () {
            ...
            if ("[object Array]" === {}.toString.call(t) && "[object Array]" === {}.toString.call(e)) {
                ...
                for (o = s = 0, a = t.length; a > s; o = ++s)if (i = t[o], !this._equal(i, e[o]))return !1;
                return !0
            }
            return t === e
        }, e
