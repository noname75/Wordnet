...
+function (t) {
    ...
    o.VERSION = "3.3.7", o.TRANSITION_DURATION = 150, o.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var i = this, r = this.tip(), s = this.getUID(this.type);
        ...
        var u = /top|bottom/.test(o), c = u ? 2 * l.left - i + p : 2 * l.top - r + h, d = u ? "offsetWidth" : "offsetHeight";
        ...
        var i = this, r = t(this.$tip), s = t.Event("hide.bs." + this.type);
        ...
        e = e || this.$element;
        var o = e[0], n = "BODY" == o.tagName, i = o.getBoundingClientRect();
        null == i.width && (i = t.extend({}, i, {width: i.right - i.left, height: i.bottom - i.top}));
        var r = window.SVGElement && o instanceof window.SVGElement, s = n ? {
            top: 0,
            left: 0
        } : r ? null : e.offset(), a = {scroll: n ? document.documentElement.scrollTop || document.body.scrollTop : e.scrollTop()}, p = n ? {
    ...
    return o = window.document, e = function () {
        ...
        return e.prototype.addSteps = function (t) {
            ...
            return this._debug("Scroll into view. ScrollTop: " + p + ". Element offset: " + a + ". Window height: " + h + "."), r = 0, t("body, html").stop(!0, !0).animate({scrollTop: Math.ceil(p)}, function (t) {
                return function () {
            ...
            return this.backdrop.backgroundShown ? void 0 : (this.backdrop = t("<div>", {"class": "tour-backdrop"}), this.backdrop.backgroundShown = !0, t(e.backdropContainer).append(this.backdrop))
            ...
            if ("[object Object]" === {}.toString.call(t) && "[object Object]" === {}.toString.call(e)) {
                ...
                for (o in t)if (r = t[o], !this._equal(e[o], r))return !1;
                return !0
            }
            if ("[object Array]" === {}.toString.call(t) && "[object Array]" === {}.toString.call(e)) {
                if (t.length !== e.length)return !1;
                for (o = s = 0, a = t.length; a > s; o = ++s)if (r = t[o], !this._equal(r, e[o]))return !1;
                return !0
            }
            return t === e
        }, e
